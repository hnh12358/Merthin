...
module internal StringsResources =
    ...
    let FMATRIX_STRASSENPRODUCT_BADDIMENSIONS = "The matrixs must have the same dimensions and be square."
    let FMATRIX_STRASSENPRODUCT_BADDIMENSIONS_NOPOWEROFTWO = "The matrixs must have their dimesions equal to the same power of two."

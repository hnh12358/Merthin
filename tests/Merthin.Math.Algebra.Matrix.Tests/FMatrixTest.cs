...
namespace Merthin.Math.Algebra.Matrix.Tests
{
    ...
    public class FMatrixTest
    {
        ...
        ///</summary>
        [Test]
        public void ToString_AllRowsAllColumns_Correct()
        {
            ...
            var actual = matrix.ToString(null, null, Format, String.Empty, '0');
        ...
        ///</summary>
        [Test]
        public void ToString_FewRowsAllColumns_Correct()
        {
            var matrixStr = "01 02 03 04 05 06\n" +
                            "08 09 10 04 05 06\n" +
                            "01 02 03 04 05 06\n" +
            ...
            var matrix = FMatrixModule.fromString(matrixStr);
            var actual = matrix.ToString(3, null, Format, String.Empty, '0');
        ...
        public void ToString_AllRowsFewColumns_Correct()
        {
            ...
            var matrix = FMatrixModule.fromString(matrixStr);
            var actual = matrix.ToString(null, 3, Format, String.Empty, '0');
            Assert.AreEqual(expectedStr, actual);
        }
        ...
        public void ToString_FewRowsFewColumns_Correct()
        {
            ...
            var matrix = FMatrixModule.fromString(matrixStr);
            var actual = matrix.ToString(3, 3, Format, String.Empty, '0');
            Assert.AreEqual(expectedStr, actual);
        }
